...
import org.sample.service.role.RoleService;
import org.sample.service.role.RoleServiceImpl;
import org.sample.service.user.UserService;
import org.sample.service.user.UserServiceImpl;
import org.sample.util.Constants;
import org.sample.util.PageSupport;
...
public class UserServlet extends HttpServlet {
    ...
    private void delUser(HttpServletRequest request, HttpServletResponse response)
        ...
        if(delId <= 0){
            ...
            UserService userService = new UserServiceImpl();
            if(userService.deleteUserById(delId)){ // 此处需要处理事务
